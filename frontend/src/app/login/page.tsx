    ...
    <div className="flex-1 flex flex-col justify-center items-center min-h-screen px-6 py-12">
      ...
      >
        <div className="flex flex-col items-center gap-2 text-center">
          ...
          <h2 className="text-2xl font-extrabold tracking-tight">Unlock Your Vault</h2>
          <p className="text-sm text-slate-500">Enter your credentials to decrypt your keys</p>
        </div>
